...
export const driveeContentRu = {
  ...
  outcome: "Drivee Peak получил награду хакатона «Лучший дизайн приложения». После хакатона проект не был коммерчески запущен или продан, поэтому в кейсе нет заявлений о бизнес-метриках или результатах запуска.",
  limitations: {
    title: "Ограничения",
